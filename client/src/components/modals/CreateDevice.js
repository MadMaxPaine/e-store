    ...
    >
      <Fade in={show}>
        <Box sx={style} component="form">
          ...
          >
            <Box item>
              <InputLabel id="brand-simple-select" align="center">
                Brand
              </InputLabel>
              <Select
                fullWidth
            ...
            <Box item>
              <InputLabel id="type-simple-select" align="center">
                Type
              </InputLabel>
              <Select
                fullWidth
          ...
          >
            <InputLabel id="file-simple-select">
              Add device qualities
            </InputLabel>
          </Box>
          <Grid container>
            <Button variant="contained" sx={{ m: 1 }} onClick={addInfo}>
              Add info
            </Button>
            {info.map((i) => (
              <Grid
              ...
              >
                <Box sx={{ display: "inline-flex", m: 1, spaicing: 1 }}>
                  <Box item md={4} direction="column" p={1}>
                    <TextField
                      variant="standard"
                      size="small"
                      id="title"
          ...
          >
            <Button variant="contained" sx={{ mr: 1 }} onClick={onHide}>
              Close
            </Button>
            <Button variant="contained" sx={{ mr: 1 }} onClick={addDevice}>
              Add
            </Button>
          </Grid>
        </Box>
